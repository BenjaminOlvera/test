...
import threading
import src.globals
from src.analyser import get_face_single, get_face_many
...
def multi_process_frame(source_img, frame_paths, progress):
    threads = []
    num_threads = src.globals.gpu_threads
...
def process_video(source_img, frame_paths):
    do_multi = src.globals.gpu_vendor is not None and src.globals.gpu_threads > 1
